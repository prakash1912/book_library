                ...
                <div class="row">
                    <div class="main-wrapper">
                        <div class="sub-wrapper-01">
                            <div class="content">
                                <h1>A book is a medium for recording information</h1>
                                <p>A single part or division of a longer written work may also be called a book.</p>
                                <div class="btn-01">
                                </div>
                            </div>
                        </div>
                        <div class="sub-wrapper-01">
                            <div class="image">
                                <div class="my-ba" style="height: 500px; width: 500px;">
                                    <img src="assets/images/slider/lib_book.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
